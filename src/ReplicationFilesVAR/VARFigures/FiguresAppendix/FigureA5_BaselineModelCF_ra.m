...
y=[unem nunem corepceinfl gdpinfl 100*(rgdp-log(pop)) 100*(h-log(pop)) aheinfl ls epr rgdpgap];
series=["unemployment","natural unemployment","core inflation","inflation","GDP","hours","wage inflation (PNSE)","labor share","employment-to-population ratio","output gap"]
...
% plot of the impulse responses of unemployment and other real activity measures
