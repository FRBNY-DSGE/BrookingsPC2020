...
enddate1=1993.75; T11=find(Time==enddate1);

% second sample
startdate2=1994-lags/4; T02=find(Time==startdate2);
...
subplot(3,3,1); plots=get(gca, 'Children'); legend(plots([7 4]),{'pre 1994','post 1994'},'Location','northeast');
